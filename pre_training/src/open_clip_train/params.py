...
def parse_args(args):
    ...
    parser.add_argument(
        "--dataset-type",
        choices=["webdataset", "csv", "synthetic", "auto", "pmc"],
        default="auto",
    ...
    parser.add_argument(
        ...
        type=str,
        default=None,
        help="For csv-like datasets, the name of the key for the metadata."
    )
    parser.add_argument(
        "--imagenet-val",
        type=str,
    ...
    parser.add_argument(
        "--requires_vision_grad",
        type=str,
        default="all",
        help="Specify which vision backbone layers require gradients. For example, 'all' or '.6.,.7.,.8.,.9.,.10.,.11.,norm.,attn_pool.'.",
    )
    parser.add_argument(
        "--pretrained",
        default='',
    ...
    parser.add_argument(
        ...
        default=False,
        action='store_true',
        help="Test the bottleneck of the training procedure."
    )
    parser.add_argument(
        "--no-set-device-rank",
        default=False,
    ...
    parser.add_argument(
        ...
        default=False,
        action="store_true",
        help='Use SigLipConcept (sigmoid) loss.'
    )
    parser.add_argument(
        "--siglipconceptlse",
        default=False,
        action="store_true",
        help="Use SigLipConceptLSE (sigmoid) loss."
    )
    parser.add_argument(
        "--sigliptoken",
        default=False,
        action="store_true",
        help='Use SigLipToken (sigmoid) loss.'
    )
    parser.add_argument(
        "--concept-loss-weight",
        type=float,
        default=1.0,
        help="Weight assigned to contrastive loss when training SigLipConcept."
    )
