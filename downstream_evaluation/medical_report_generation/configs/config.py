...
parser.add_argument('--annotation', type=str, default=r'/home/chenzhixuan/Workspace/ConceptCLIP_MRG/dataset/annotation.json', help="annotation file of the dataset")
parser.add_argument('--base_dir', type=str, default=r'/project/smartlab2021/zchenhi/data/iu_xray/images"', help="base dir to help find images")
...
parser.add_argument('--llama_model', default='models/ckpt/Llama-2-7b-chat-hf', type=str, help="LLM model to use")
